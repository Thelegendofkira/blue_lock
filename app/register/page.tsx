...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      ...
      >
        <div className="absolute -top-60 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full bg-blue-600/8 blur-3xl" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-blue-900/6 blur-3xl" />
      </div>
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 backdrop-blur-sm p-8 shadow-2xl shadow-black/60">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-zinc-400">
              Start managing your time and goals today.
            </p>
          </div>
